...
FVector2D BrickTemplate::GetWallKickData(BrickType InBrickType, BrickDirection InDirection, EMInput Rotation, uint8 TryNum, EDropStartDirection InStartDirection)
{
	FVector2D res;
...
vector<vector<FVector2D>> BrickTemplate::WallKickData =
{
...
vector<vector<FVector2D>> BrickTemplate::I_WallKickData =
{
	//Try 0,		Try 1,			Try 2,			  Try 3,		  Try 4
