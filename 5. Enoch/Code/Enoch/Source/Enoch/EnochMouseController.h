...
class ENOCH_API AEnochMouseController : public APlayerController
{
	GENERATED_BODY()
public :
	/**드래드 드롭 용병 스폰. widget to field. 필드 내부 이동도 widget 거치기 때문에 사용함. 델리게이트 바인딩으로 사용*/
	...
	FreeLancerSaveData GetCurrentFLUnderCursor(){return CurrentFLUnderCursor;}
...
protected :
	...
	FreeLancerSaveData CurrentFLUnderCursor;
