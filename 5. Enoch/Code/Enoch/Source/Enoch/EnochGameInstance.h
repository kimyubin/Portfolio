 ...
 * <p> bool isSelected, PanelType selectPanel, int slotNum, FreeLancerTemplateID fTID, int freelancerLv
 */
...
public:
	...
	FSelectedFreelancer(bool isSelected, PanelType selectPanel, int slotNum, FreeLancerTemplateID fTID, int freelancerLv)	
	{
	...
	FSelectedFreelancer(PanelType selectPanel, int slotNum, FreeLancerTemplateID fTID)	
	{
		IsSelected = true;
		SelectedPanel = selectPanel;
		SlotNum = slotNum;	
	...
	FSelectedFreelancer(FVector2D fieldPos, FreeLancerTemplateID fTID)	
	{
		IsSelected = true;
	...
	int SlotNum;
	UPROPERTY(EditAnywhere, BlueprintReadWrite)
	FreeLancerTemplateID FreeLancerTID;
	UPROPERTY(EditAnywhere, BlueprintReadWrite)
	int FreelancerLv;
	UPROPERTY(EditAnywhere, BlueprintReadWrite)
	FVector2D FieldPos;
...
public:
	...
	/** 필드 용병 선택 기능*/
	void LiftFreeLancerInField(const FVector2D &CellLocation);
};
