...
TMap<FreeLancerTemplateID, USkeletalMesh*> AFLAnimLoader::Meshes;
TMap<FreeLancerTemplateID, TSubclassOf<UAnimInstance>> AFLAnimLoader::Anims;
...
void AFLAnimLoader::LoadMeshFile(const wchar_t* path, FreeLancerTemplateID type)
{
...
void AFLAnimLoader::LoadAnimFile(const wchar_t* path, FreeLancerTemplateID type)
{
...
USkeletalMesh* AFLAnimLoader::GetMesh(FreeLancerTemplateID templateID)
{
...
TSubclassOf<UAnimInstance> *AFLAnimLoader::GetAnim(FreeLancerTemplateID templateID)
{
	//if (instance == nullptr) return nullptr;
