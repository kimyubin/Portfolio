...
public:	
	...
	class AEnochFreeLancer* GetAttachedFreeLancer() { return AttachedFreeLancer; }
	...
	UFUNCTION(BlueprintCallable, Category = "FieldCell")
	bool HasAttachFreeLancer() { return (AttachedFreeLancer != nullptr); }
...
//private :
	...
	class AEnochFreeLancer* AttachedFreeLancer;
